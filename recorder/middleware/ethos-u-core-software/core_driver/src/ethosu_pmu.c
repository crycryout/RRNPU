 ...
 *****************************************************************************/
 ...
 {
     LOG_INFO("pmu_event_type called.");  // [Called]
     switch (id)
     {
 ...
 {
     LOG_INFO("pmu_event_value called.");  // [Called]
     int a = event;
 ...
 {
     LOG_INFO("ETHOSU_PMU_Enable called.");  // [Called]
 ...
 {
     LOG_INFO("ETHOSU_PMU_Disable called.");  // [Called]
 ...
 {
     LOG_INFO("ETHOSU_PMU_Get_NumEventCounters called.");  // [Called]
 ...
 {
     LOG_INFO("ETHOSU_PMU_Set_EVTYPER called.");  // [Called]
 ...
 {
     LOG_INFO("ETHOSU_PMU_Get_EVTYPER called.");  // [Called]
     assert(num < ETHOSU_PMU_NCOUNTERS);
 ...
 {
     LOG_INFO("ETHOSU_PMU_CYCCNT_Reset called.");  // [Called]
 ...
 {
     LOG_INFO("ETHOSU_PMU_EVCNTR_ALL_Reset called.");  // [Called]
 ...
 {
     LOG_INFO("ETHOSU_PMU_CNTR_Enable called.");  // [Called]
 ...
 {
     LOG_INFO("ETHOSU_PMU_CNTR_Disable called.");  // [Called]
     LOG_DEBUG("mask=0x%08x", mask);
 ...
 {
     LOG_INFO("ETHOSU_PMU_CNTR_Status called.");  // [Called]
 ...
 {
     LOG_INFO("ETHOSU_PMU_Get_CCNTR called.");  // [Called]
 ...
 {
     LOG_INFO("ETHOSU_PMU_Set_CCNTR called.");  // [Called]
 ...
 {
     LOG_INFO("ETHOSU_PMU_Get_EVCNTR called.");  // [Called]
     assert(num < ETHOSU_PMU_NCOUNTERS);
 ...
 {
     LOG_INFO("ETHOSU_PMU_Set_EVCNTR called.");  // [Called]
     assert(num < ETHOSU_PMU_NCOUNTERS);
     LOG_DEBUG("num=%u, val=%u", num, val);
 ...
 {
     LOG_INFO("ETHOSU_PMU_Get_CNTR_OVS called.");  // [Called]
     LOG_DEBUG("");
 ...
 {
     LOG_INFO("ETHOSU_PMU_Set_CNTR_OVS called.");  // [Called]
     LOG_DEBUG("");
 ...
 {
     LOG_INFO("ETHOSU_PMU_Set_CNTR_IRQ_Enable called.");  // [Called]
     LOG_DEBUG("mask=0x%08x", mask);
 ...
 {
     LOG_INFO("ETHOSU_PMU_Set_CNTR_IRQ_Disable called.");  // [Called]
     LOG_DEBUG("mask=0x%08x", mask);
 ...
 {
     LOG_INFO("ETHOSU_PMU_Get_IRQ_Enable called.");  // [Called]
 ...
 {
     LOG_INFO("ETHOSU_PMU_CNTR_Increment called.");  // [Called]
     LOG_DEBUG("");
 ...
 {
     LOG_INFO("ETHOSU_PMU_PMCCNTR_CFG_Set_Start_Event called.");  // [Called]
 ...
 {
     LOG_INFO("ETHOSU_PMU_PMCCNTR_CFG_Set_Stop_Event called.");  // [Called]
 ...
 {
     LOG_INFO("ETHOSU_PMU_Get_QREAD called.");  // [Called]
 ...
 {
     LOG_INFO("ETHOSU_PMU_Get_STATUS called.");  // Inserted LOG_INFO [Called]
